...
impl<T: AbsDiffEq + Num> AbsDiffEq for Vec3<T>
where
    T::Epsilon: Copy,
{
...
impl<T: RelativeEq + Num> RelativeEq for Vec3<T>
where
    T::Epsilon: Copy,
{
...
impl<T: UlpsEq + Num> UlpsEq for Vec3<T>
where
    T::Epsilon: Copy,
{
